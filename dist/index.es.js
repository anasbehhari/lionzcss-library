...
var css_248z$2 = ".Alert-lz{border-radius:5px;display:-webkit-box;display:-ms-flexbox;display:flex;max-width:100%;min-width:400px;padding:2px 0;position:relative;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}.Alert-lz.error{background-color:#e74c3c;border-color:#e74c3c;color:#e74c3c}.Alert-lz.success{background-color:#2ecc71;border-color:#2ecc71;color:#2ecc71}.Alert-lz.warning{background-color:#f1c40f;border-color:#f1c40f;color:#f1c40f}.Alert-lz.info{background-color:#409efb;border-color:#409efb;color:#409efb}.Alert-lz .icon{fill:#fff;cursor:pointer;display:-webkit-box;display:-ms-flexbox;display:flex;justify-content:center;margin:15px 20.5px;width:1.5rem}.Alert-lz .Alert-content{background-color:hsla(0,0%,100%,.97)!important;border-radius:0 3px 3px 0;display:flex;flex-direction:column;gap:3px;padding:10px;position:relative;width:calc(100% - 87px)}.Alert-lz .Alert-content *{margin:0;padding:0}.Alert-lz .Alert-content p{color:#000}";
...
const Alert = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `Alert-lz ${type} ${className} `
  ...
  }, /*#__PURE__*/React.createElement("h3", null, props.title), props.children));
};
Alert.propTypes = {
